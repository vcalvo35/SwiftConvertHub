...
(function () {
  ...
  function createBanner() {
    ...
    btnGroup.appendChild(makeBtn('Accept', 'accepted', '#2563eb', '#fff'));
    btnGroup.appendChild(makeBtn('Decline', 'declined', 'transparent', '#94a3b8'));
    btnGroup.children[1].style.border = '1px solid #475569';
