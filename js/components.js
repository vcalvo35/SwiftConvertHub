...
(function () {
  ...
  const i18n = {
    ...
    es: {
      ...
      label_input_base: 'Base de Entrada',
      label_enter_number: 'Ingresar N\u00famero',
      ph_enter_value: 'Ingresa un valor',
      ph_result: 'Resultado',
      ph_enter_number: 'ej. 255',
      // Binary output labels
      bin_label_dec: 'Decimal (Base 10)',
      bin_label_bin: 'Binario (Base 2)',
      bin_label_hex: 'Hexadecimal (Base 16)',
      bin_label_oct: 'Octal (Base 8)',
      // Why section
      ...
      footer_length: 'Longitud y Distancia',
      footer_weight: 'Peso y Masa',
      footer_temp: 'Temperatura',
      footer_storage: 'Almacenamiento Digital',
      footer_binary: 'Binario y N\u00fameros',
      footer_col2_h4: 'P\u00e1ginas',
      ...
      about_h1: 'Acerca de SwiftConvertHub',
      about_p1: 'SwiftConvertHub es un conversor de unidades gratuito, r\u00e1pido y preciso, dise\u00f1ado para todos: estudiantes, ingenieros, desarrolladores, viajeros y mentes curiosas.',
      about_p2: 'Creamos SwiftConvertHub porque la conversi\u00f3n de unidades deber\u00eda ser simple e instant\u00e1nea. Sin formularios de registro, sin interfaces complicadas, sin muros de pago. Solo abre la herramienta y convierte.',
      about_offer_h2: 'Lo Que Ofrecemos',
      about_promise_h2: 'Nuestra Promesa',
      about_promise_p: 'SwiftConvertHub siempre ser\u00e1 gratuito. Podemos mostrar anuncios no intrusivos para mantener el sitio en l\u00ednea, pero nunca requeriremos una cuenta, nunca venderemos tus datos y nunca pondremos conversores detr\u00e1s de un muro de pago.',
      ...
      contact_p: '\u00bfTienes una sugerencia, encontraste un error, o solo quieres saludar? Env\u00edanos un mensaje.',
